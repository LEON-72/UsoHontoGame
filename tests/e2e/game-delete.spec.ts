...
test.describe('Game Deletion', () => {
  ...
  test('should show warning message about cascade deletion', async ({ page }) => {
  ...
  test('should show confirmation dialog when delete button is clicked', async ({ page }) => {
    ...
    await expect(page.locator('text=このゲームを削除しますか')).toBeVisible();
  ...
  test('should cancel deletion when cancel button is clicked', async ({ page }) => {
    ...
    await expect(page.locator('text=このゲームを削除しますか')).not.toBeVisible();
    await expect(page.locator('text=ゲームを削除')).toBeVisible();
  });

  test('should successfully delete a game in preparation status', async ({ page }) => {
    // Given: On game detail page
    await page.goto('/games');
  ...
  test('should show different confirmation for active game', async ({ page }) => {
  ...
  test('should remove game from list immediately after deletion', async ({ page }) => {
